RestructAPIModel=<class 'restruct_oc_model.RestructAPIModel'>
_roc=<module 'restruct_oc_model' from '/Users/aneeshkalla/Desktop/Restruct/backend_code/notebooks/restruct_oc_model.py'>
...
build_restruct_models=<function build_restruct_models at 0x17edb5bd0>
custom_imports=dict(
    allow_failed_imports=False,
    imports=[
        'restruct_oc_model',
        'backend_code.models_config',
        ])
datasets=[
...
importlib=<module 'importlib' from '/Users/aneeshkalla/anaconda3/envs/opencompass/lib/python3.10/importlib/__init__.py'>
models=[
    dict(abbr='restruct_openai_gpt_5',
        batch_size=1,
        max_out_len=512,
        max_seq_len=128000,
        query_per_second=1,
        ...
        run_cfg=dict(
            num_gpus=0,
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_openai_gpt_5_mini',
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_openai_gpt_5_nano',
        batch_size=1,
        max_out_len=512,
        max_seq_len=128000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_google_gemini_2.5_pro',
        batch_size=1,
        max_out_len=512,
        max_seq_len=1000000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_google_gemini_2.5_flash',
        batch_size=1,
        max_out_len=512,
        max_seq_len=1000000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_google_gemini_2.5_flash_lite',
        batch_size=1,
        max_out_len=512,
        max_seq_len=1000000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_google_gemini_2.0_flash',
        batch_size=1,
        max_out_len=512,
        max_seq_len=512000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_google_gemini_2.0_flash_lite',
        batch_size=1,
        max_out_len=512,
        max_seq_len=512000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_anthropic_claude_opus_4_1',
        batch_size=1,
        max_out_len=512,
        max_seq_len=200000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_anthropic_claude_sonnet_4_5',
        batch_size=1,
        max_out_len=512,
        max_seq_len=200000,
        query_per_second=1,
        ...
        run_cfg=dict(
            ...
            num_procs=1),
        type=<class 'restruct_oc_model.RestructAPIModel'>),
    dict(abbr='restruct_anthropic_claude_haiku_4_5',
        batch_size=1,
        max_out_len=512,
        max_seq_len=200000,
        query_per_second=1,
...
work_dir='outputs/20251129_031222'