custom_imports=dict(
    ...
    imports=[
        '/Users/aneeshkalla/Desktop/Restruct/backend_code/notebooks/restruct_oc_model',
        ])
datasets=[
...
models=[
    ...
    dict(abbr='restruct_claude_sonnet',
        batch_size=1,
        max_out_len=512,
        max_seq_len=4096,
        query_per_second=1,
...
work_dir='outputs/20251126_221749'